 ...
 */
function genderselfidentify_civicrm_postInstall() {
  _genderselfidentify_civix_civicrm_postInstall();
}
 ...
 */
function genderselfidentify_civicrm_caseTypes(&$caseTypes) {
  _genderselfidentify_civix_civicrm_caseTypes($caseTypes);
}
 ...
 */
function genderselfidentify_civicrm_angularModules(&$angularModules) {
  _genderselfidentify_civix_civicrm_angularModules($angularModules);
}
 ...
 */
function genderselfidentify_civicrm_entityTypes(&$entityTypes) {
  _genderselfidentify_civix_civicrm_entityTypes($entityTypes);
}
 ...
 *
function genderselfidentify_civicrm_preProcess($formName, &$form) {
 ...
 *
function genderselfidentify_civicrm_navigationMenu(&$menu) {
  _genderselfidentify_civix_insert_navigation_menu($menu, 'Mailings', array(
  ...
  _genderselfidentify_civix_navigationMenu($menu);
} // */
